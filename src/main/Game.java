...
public class Game {
	...
	public static void main(String[] args) {
		...
		Camera camera = new Camera(new Vector3f(0, 16, 0), 0, 0, 0);
		
		//Generate terrain with seed 0
		PerlinNoiseGenerator generator = new PerlinNoiseGenerator(0);
		...
		GuiTexture crosshair = new GuiTexture(loader.loadTexture("crosshair"), new Vector2f(0.0f, 0.0f), new Vector2f(0.01175f, 0.01175f * 16f/9f));
		GuiTexture hotbar = new GuiTexture(loader.loadTexture("hotbarNew"), new Vector2f(0.0f, -0.9375f), new Vector2f(0.3f, 0.3f * 16f/9f));
		guis.add(crosshair);
		guis.add(hotbar);
